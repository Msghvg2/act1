    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <center>
                        <h1>Actividades Parcial II</h1>
                        <h1>3B - IRD</h1>
                        <br><br><br><br>
                        <h3>Aquí estarán contenidas todas las actividades de la materia Aplicaciones Web</h3><br><br><br><br><br><br><br><br><br><br><br>
                        <p>Elaborado por: Manuel Alejandro González May</p>
                    </center>
                </div>
            </div>
        </div>
