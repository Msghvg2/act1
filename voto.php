...
<html lang="en">
    <head>
        ...
        <title>Verificación de voto</title>
        <!-- Favicon-->
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="mt-4">Verificación de voto</h1>
                    <p>
                    ...
                    if ($_POST) 
                    {
                        ...
                        echo "<br><h1>Resultado</h1>";
                        if ($pvotar == true) 
                        {
                        echo "<p>Usted puede votar.</p>";
                        } else 
                        {
                        echo "<p>Usted no puede votar.</p>";
                        }
                    }
                    ?>
                    </p>
